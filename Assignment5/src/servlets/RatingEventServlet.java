...
public class RatingEventServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		mysql.changeRating(TMDBapi.getIMDBid(title), Integer.parseInt(request.getParameter(StringConstants.RATING)));
		//write back the new average rating
		response.getWriter().write(Long.toString(mysql.getMovieByTitle(title).getAverageRating()));
	}
