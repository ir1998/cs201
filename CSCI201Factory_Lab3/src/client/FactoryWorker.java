...
public class FactoryWorker extends FactoryObject implements Runnable, FactoryReporter {
	...
	public FactoryWorker(int inNumber, FactoryNode startNode, Factory inFactory) {
		super(Constants.workerString + String.valueOf(inNumber),
		"Worker" + Constants.png);
	...
	public FactoryWorker(FactoryWorker toClone) {
		super(Constants.workerString + String.valueOf(toClone.number),
		"Worker" + Constants.png);
	...
	public void start() {
		...
		System.out.println("Worker " + number + " has been started");
		thread.start();
	}
